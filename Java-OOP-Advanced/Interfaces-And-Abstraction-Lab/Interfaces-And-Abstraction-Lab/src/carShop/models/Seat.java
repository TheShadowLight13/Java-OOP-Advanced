...
import carShop.interfaces.Sellable;
...
public class Seat implements Sellable{
    ...
    public String toString() {
        return String.format("This is %s produced in %s and have %s tires, price: %.2f",
                this.getModel(), this.getCountryProduced(), Car.TIRES, this.getPrice());
    }
}
